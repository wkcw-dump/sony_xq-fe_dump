...
*/
/* SONY_BEGIN (JIML-299432 - According to ORM, local ecc shall be set up as normal call) */
/*
...
*/
/* SONY_END (JIML-299432 - According to ORM, local ecc shall be set up as normal call) */
